                    ...
                    switch (inp)
                    {
                        ...
                        case "CHECK_BOOK":
                            ...
                            switch (inp2)
                            {
                                ...
                                Console.WriteLine("Please enter the name of the book:");
                                book_name = Console.ReadLine();
                                Console.WriteLine("Book is in the library: " + Library.Check_book(book_name, "", 1, xml_path));
                                    break;
                                case 2:
                                    Console.WriteLine("Please enter the author:");
                                    book_aut = Console.ReadLine();
                                    Console.WriteLine("Book is in the library: " + Library.Check_book("", book_aut, 2, xml_path));
                                    break;
                                case 3:
                                    Console.WriteLine("Please enter the name of the book:");
                                    book_name = Console.ReadLine();
                                    Console.WriteLine("Please enter the author:");
                                    book_aut = Console.ReadLine();
                                    Console.WriteLine("Book is in the library: " + Library.Check_book(book_name, book_aut, 3, xml_path));
                                    break;
                            }
                            break;
                        case "POPULAR_IN_GENRE":
                            ...
                            book_genre = (Genre)int.Parse(Console.ReadLine());
                            Book pop_book = Library.Find_pop_book_in_genre(book_genre, xml_path);
                            if (pop_book == null)
                            {
