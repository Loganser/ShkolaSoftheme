...
CREATE DATABASE [$(DatabaseName)]
    ...
    LOG ON (NAME = [$(DatabaseName)_log], FILENAME = N'$(DefaultLogPath)$(DefaultFilePrefix)_Primary.ldf') COLLATE Ukrainian_CI_AS
GO
IF EXISTS (SELECT 1
...
GO
PRINT N'Creating [IIS APPPOOL\DefaultAppPool]...';
...
GO
PRINT N'Creating [WebAppUser]...';


GO
CREATE USER [WebAppUser] FOR LOGIN [IIS APPPOOL\DefaultAppPool];


GO
REVOKE CONNECT TO [WebAppUser];
